        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="service-card">
                    <img src="/images/layanan kami/studi-s1.png" alt="Studi S1">
            ...
            <div class="col-md-4 mb-4">
                <div class="service-card">
                    <img src="/images/layanan kami/s2.png" alt="Studi S2">
                    <div class="service-card-content">
            ...
            <div class="col-md-4 mb-4">
                <div class="service-card">
                    <img src="/images/layanan kami/phd.png" alt="Studi S3">
                    <div class="service-card-content">
            ...
            <div class="col-md-4 mb-4">
                <div class="service-card">
                    <img src="/images/layanan kami/kursus-bahasa.png" alt="Kursus Bahasa">
                    <div class="service-card-content">
    ...
    <div class="container">
        ...
        <div class="article-grid">
            ...
            <a href="#" class="article-item">
                <img src="/images/layanan kami/fakta.png" alt="Artikel" class="article-image">
                <p class="article-title">5 Fakta yang Harus Kamu Ketahui Sebelum Studi ke Jerman</p>
            </a>

            <!-- Article 2 -->
            <a href="#" class="article-item">
                <img src="/images/layanan kami/korona.png" alt="Artikel" class="article-image">
                <p class="article-title">Uni Eropa Menghadapi Virus Korona</p>
            </a>

            <!-- Article 3 -->
            <a href="#" class="article-item">
                <img src="/images/layanan kami/bahasajerman.png" alt="Artikel" class="article-image">
                <p class="article-title">Belajar Bahasa Jerman Bersama Goethe Institut</p>
            </a>

            <!-- Article 4 -->
            <a href="#" class="article-item">
                <img src="/images/layanan kami/gatescambride.png" alt="Artikel" class="article-image">
