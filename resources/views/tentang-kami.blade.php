    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                <div class="visi-misi-card">
                    <div class="visi-misi-image">
                        <img src="/images/layanan kami/visi.png" alt="Visi">
                    </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="visi-misi-card">
                    <div class="visi-misi-image">
                        <img src="/images/layanan kami/misi.png" alt="Misi">
                    </div>
                    <div class="visi-misi-content">
                        <h3 class="visi-misi-title">MISI</h3>
                        <p class="visi-misi-text">Memfasilitasi siswa Indonesia untuk mengenyam pendidikan di berbagai perguruan tinggi di lebih dari 25 negara maju di dunia dengan layanan yang profesional</p>
                        <p class="visi-misi-text mt-3">Memberikan bantuan konsultasi terhadap siswa/i Indonesia dalam mempersiapkan studinya dari berbagai aspek, baik aspek sosial, budaya, maupun pendidikan</p>
                    </div>
                </div>
            </div>
        </div>
...
/* Hero Section */
.page-hero {
    background: url('/images/layanan kami/tentang.png');
